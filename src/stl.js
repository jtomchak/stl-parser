...
var grammar = {
    ...
    {"name": "main", "symbols": ["main$string$1", "name", "facet", "loop", "end_facet"]},
    {"name": "name", "symbols": ["string", "newline"]},
    {"name": "facet$subexpression$1$string$1", "symbols": [{"literal":"f"}, {"literal":"a"}, {"literal":"c"}, {"literal":"e"}, {"literal":"t"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "facet$subexpression$1", "symbols": ["_", "facet$subexpression$1$string$1", "facetType", "int", "_", "int", "_", "int", "newline"]},
    ...
    {"name": "vertex", "symbols": ["_", "vertex$string$1", "_", "int", "_", "int", "_", "int", "newline"]},
